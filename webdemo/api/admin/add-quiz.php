...
$sql = "INSERT INTO quizzes (question, option_a, option_b, option_c, option_d, correct_answer, explanation) VALUES ('" . 
       $conn->real_escape_string($question) . "', '" . 
       $conn->real_escape_string($option_a) . "', '" . 
       $conn->real_escape_string($option_b) . "', '" . 
       $conn->real_escape_string($option_c) . "', '" . 
       $conn->real_escape_string($option_d) . "', '" . 
       $conn->real_escape_string($correct_answer) . "', '" . 
       $conn->real_escape_string($explanation) . "')";
